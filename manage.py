#manage.py — это стандартный файл в проектах Django, который служит точкой входа для выполнения различных административных задач, таких как запуск сервера разработки, миграция базы данных и создание суперпользователей. Этот файл позволяет вам взаимодействовать с вашим проектом через командную строку.
#!/usr/bin/env python
